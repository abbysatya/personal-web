...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Abby Satya
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I am someone who is interested in the fields of Videography, Photography, and UI Design. 
        I have experience in various types of projects ranging from creating short movies to studio photography 
        and creating attractive UI designs.
        </p>
